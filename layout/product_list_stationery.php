...
<body>
    ...
    <div class="container">
        <nav class="navbar2">
            <ul>
                ...
                <li><a href="product_list_stationery.php" style="color: #4568DC;">문구</a></li>
            </ul>
        </nav>    
    </div>
    ...
    <section>
        ...
        <?php
            $CID = 5;
            $category_cnt = $db->query("select COUNT(PID) as 해당물품수 from product where CID = $CID group by CID;");
